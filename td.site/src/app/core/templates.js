...
const templatesModule = angular
	...
	.run(['$templateCache', function($templateCache) {
		$templateCache.put('diagrams/CiaEditPane.html', '<div>\n' +
			...
			'                    <option selected="selected">Confidentiality</option>\n' +
		...
		$templateCache.put('diagrams/confirmReloadOnDirty.html', '<div>\n' +
			'    <div class="modal-header">\n' +
			'        <h3>Are you sure?</h3>\n' +
			'    </div>\n' +
			'    <div class="modal-body">\n' +
		...
		$templateCache.put('diagrams/diagrameditor.html', '<div data-ng-controller="diagram as vm" class="container-fluid diagram-container">\n' +
		...
		$templateCache.put('diagrams/ElementPropertiesPane.html', '<form name="elementPropertiesEditForm">\n' +
			'    <div>\n' +
			'        <div class="form-group">\n' +
			'            <label>Name</label>\n' +
		...
		$templateCache.put('diagrams/LinddunEditPane.html', '<div>\n' +
			'    <div class="modal-header">\n' +
			'        <h3>{{parameter.heading}}<span class="pull-right" ng-if="parameter.threatTotal"> ({{parameter.threatIndex}} of {{parameter.threatTotal}})</span></h3>\n' +
			'    </div>\n' +
			'    <div class="modal-body">\n' +
			...
			'                <select name="typeInput" class="form-control" ng-required="true" ng-model="parameter.threat.type">\n' +
			'                    <option selected="selected">Linkability</option>\n' +
		...
		$templateCache.put('diagrams/modalAccept.html', '<button class="btn btn-primary" ng-disabled="parameter.editing && (!threatEditForm.$dirty || !threatEditForm.$valid)" ng-click="onAction()">\n' +
			'    Accept\n' +
			'</button>');

		$templateCache.put('diagrams/modalIgnore.html', '<button class="btn btn-default" ng-click="onAction()">\n' +
			'    Ignore\n' +
			'</button>');

		$templateCache.put('diagrams/StrideEditPane.html', '<div>\n' +
			'    <div class="modal-header">\n' +
			'        <h3>{{parameter.heading}}<span class="pull-right" ng-if="parameter.threatTotal"> ({{parameter.threatIndex}} of {{parameter.threatTotal}})</span></h3>\n' +
			'    </div>\n' +
			'    <div class="modal-body">\n' +
			...
			'                <select name="typeInput" class="form-control" ng-required="true" ng-model="parameter.threat.type">\n' +
			'                    <option selected="selected">Spoofing</option>\n' +
		...
		$templateCache.put('diagrams/ThreatSummaryPane.html', '<ul id="threatSummaryPane" class="list-group">\n' +
		...
		$templateCache.put('layout/pager.html', '<div class="clearfix" ng-if="canPrevious || canNext">\n' +
		...
		$templateCache.put('layout/structuredExit.html', '<div id="structuredExitModal">\n' +
			'    <div class="modal-header">\n' +
		...
		$templateCache.put('threatmodels/confirmDelete.html', '<div>\n' +
			'    <div class="modal-header">\n' +
			'        <h3>Are you sure?</h3>\n' +
			'    </div>\n' +
			'    <div class="modal-body">\n' +
		...
		$templateCache.put('threatmodels/confirmReloadOnDirty.html', '<div>\n' +
			'    <div class="modal-header">\n' +
			'        <h3>Are you sure?</h3>\n' +
			'    </div>\n' +
			'    <div class="modal-body">\n' +
		...
		$templateCache.put('threatmodels/threatmodeldetail.html', '<div data-ng-controller="threatmodel as vm" class="container-fluid">\n' +
			...
			'                    <a class="btn btn-primary" ng-href="#/threatmodel/edit/{{vm.threatModelPath()}}" role="button" data-toggle="tooltip" data-placement="top" title="Edit This Threat Model">\n' +
			'                        <span class="glyphicon glyphicon-edit"></span> Edit\n' +
			'                    </a>\n' +
			'                    <a class="btn btn-default" ng-href="#/threatmodel/report/{{vm.threatModelPath()}}" role="button" data-toggle="tooltip" data-placement="top" title="View Or Print Threat Model Report">\n' +
		...
		$templateCache.put('threatmodels/threatmodeledit.html', '<div data-ng-controller="threatmodel as vm" class="container-fluid">\n' +
			...
			'                    <label>Title</label>\n' +
			'                    <input name="threatModelTitle" class="form-control" type="text" ng-model="vm.threatModel.summary.title" ng-required="true" placeholder="Threat model title">\n' +
			...
			'                        <div class="col-md-6">\n' +
			'                            <p>\n' +
			'                                </p><div class="input-group" ng-show="vm.addingContributor">\n' +
			...
			'                        <div class="col-md-6">\n' +
			'                            <p>\n' +
			'                                </p><div class="input-group" ng-show="vm.addingDiagram">\n' +
			...
			'                    <div class="btn-group pull-right" role="group">\n' +
			'                        <button class="btn btn-default" ng-click="vm.cancel()" data-toggle="tooltip" data-placement="top" title="Cancel Editing" type="button">\n' +
			'                            <span class="glyphicon glyphicon-remove"></span> Cancel\n' +
			'                        </button>\n' +
			'                        <button class="btn btn-default" ng-disabled="!vm.dirty" ng-click="vm.reload()" data-toggle="tooltip" data-placement="top" title="Reset Form" type="button">\n' +
			'                            <span class="fa fa-undo"></span> Reload\n' +
			'                        </button>\n' +
			'                        <button class="btn btn-primary" ng-disabled="!vm.dirty || !vm.threatModelEditForm.$valid" ng-click="vm.isNewModel() ? vm.create() : vm.save()" data-toggle="tooltip" data-placement="top" title="Save Changes" type="button">\n' +
		...
		$templateCache.put('threatmodels/threatmodelreport.html', '<div ng-if="!isPrintingOrSaving" class="panel panel-default">\n' +
			'    <div class="panel-body">\n' +
			'        <div class="pull-left">\n' +
			'            <div>\n' +
