angular.module('templates', [])
  ...
  $templateCache.put('diagrams/diagrameditor.html',
    ...
    '                        <button class="btn btn-default" ng-model="vm.diagram.diagramType" uib-btn-radio="\'STRIDE\'" ng-click="vm.setThumbnail()" >STRIDE</button>\n' +
    '                        <label class="btn btn-default" ng-model="vm.diagram.diagramType" uib-btn-radio="\'CIA\'" ng-click="vm.setThumbnail()" >CIA</label>\n' +
    '                        <label class="btn btn-default" ng-model="vm.diagram.diagramType" uib-btn-radio="\'LINDDUN\'" ng-click="vm.setThumbnail()" >LINDDUN</label>\n' +
    '                    </span>\n' +
    '                </div>\n' +
