const ell = {
    ...
    home: {
        ...
        description:
            'Το OWASP Threat Dragon είναι μια δωρεάν, ανοιχτού κώδικα, διαπλατφορμική εφαρμογή για τη δημιουργία μοντέλων απειλών. Χρησιμοποιήστε το για να σχεδιάσετε διαγράμματα μοντελοποίησης απειλών και να εντοπίσετε απειλές για το σύστημά σας. Με έμφαση στην ευελιξία και την απλότητα, είναι εύκολα προσβάσιμο για όλους τους τύπους χρηστών.'
    },
    providers: {
        desktop: {
    ...
    report: {
        options: {
            ...
            showProperties: 'Εμφάνιση ιδιοτήτων στοιχείων',
