...
1. Download the latest version of the application for your operating system from the [InfoSecOTB Threat Dragon AI Tool releases](https://github.com/InfosecOTB/threat-dragon-ai-tool/releases) page.
